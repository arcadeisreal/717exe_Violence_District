...
local RayfieldFolder = "717exe - Violence District"
...
local function Hide(notify: boolean?)
	if MPrompt then
        MPrompt.Title.Text = "717exe - Violence District" -- 🟡 Ganti teks di tombol
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if not requestsDisabled then
		sendReport("window_created", '717exe - Violence District' or "Unknown")
	end
	local Passthrough = false
	Topbar.Title.Text = '717exe - Violence District'
	...
	if Settings.ShowText then
		MPrompt.Title.Text = '717exe - Violence District'
	end

	LoadingFrame.Version.TextTransparency = 1
	LoadingFrame.Title.Text = Settings.LoadingTitle or "717exe - Violence District"
		...
		task.spawn(function()
			while true do
				...
				RayfieldLibrary:Notify({
					Title = "717exe - Violence District",
